...
const VALUES = [
  {
    title: "Transparency",
    desc: "We believe in honest, straightforward dealings. Every property listing is verified and every price is accurate.",
    icon: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z",
  },
  {
    title: "Client First",
    desc: "Your needs drive every decision we make. From first contact to final handover, you are our priority.",
    icon: "M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z",
  },
  {
    title: "Local Expertise",
    desc: "Deep knowledge of Noida and NCR markets means we can guide you to the right property in the right location.",
    icon: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z",
  },
  {
    title: "End-to-End Support",
    desc: "From property discovery through documentation and registration, we handle every step of the journey.",
      ...
      <section className="py-20">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-headline text-3xl md:text-4xl text-primary mt-3 mb-8">
            ...
            <div className="text-on-surface-variant leading-relaxed space-y-4 text-left md:text-center">
              <p>
                RealtyWize was founded with a simple mission: to make property buying, selling, and leasing a transparent and hassle-free experience. We recognized that the real estate market in Noida and NCR was growing rapidly, yet finding reliable property information remained a challenge.
              </p>
              <p>
                Our team combines deep local market knowledge with modern technology to bring you verified property listings across residential, commercial, industrial, and institutional segments. Whether you&apos;re looking for your dream home, a commercial office space, or an industrial plot, we have you covered.
              </p>
              <p>
                We work directly with builders, developers, and property owners to ensure every listing on our platform is accurate, up-to-date, and fairly priced. Our consultants are available to guide you through every step of the process.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-6 md:px-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="bg-white rounded-xl p-8 border border-outline-variant/20 shadow-sm space-y-4">
              <p className="text-on-surface-variant">{SITE_CONFIG.office_address}</p>
              ...
              <Link
                href="/properties"
                className="inline-block mt-4 bg-primary text-on-primary px-8 py-3 rounded-md font-label uppercase tracking-[0.15em] text-xs hover:bg-primary-container transition-all"
              >
                Browse Properties
              </Link>
            </div>
