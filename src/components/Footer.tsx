        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/builders" className="text-on-primary/70 text-sm hover:text-on-primary transition-colors">
                  Builders &amp; Investors
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-on-primary/70">
              <li className="flex items-start gap-2">
                ...
                {siteConfig.office_address}
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                </svg>
                <a href={`tel:${siteConfig.contact_phone}`} className="hover:text-on-primary transition-colors">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href={`mailto:${siteConfig.contact_email}`} className="hover:text-on-primary transition-colors">
